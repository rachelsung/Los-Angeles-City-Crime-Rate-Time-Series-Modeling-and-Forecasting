...
lag1.plot(var[,'crime'],50) # high correlations at t-2 and seasonal (lag12,24)
lag2.plot(var[,'gdp'], var[,'crime'], 24) # t-12
lag2.plot(var[,'rent'], var[,'crime'], 8) # t-2
lag2.plot(var[,'temp'], var[,'crime'], 24) # seasonal (lag12,24)
...
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model1 training data till 2018") +
...
# valid (traintest)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model1 training data till 2019") +
...
# train,test and valid (train)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model2 training data till 2018") +
...
# valid (traintest)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model2 training data till 2019") +
...
# train,test and valid (train)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model3 training data till 2018") +
...
# valid (traintest)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model3 training data till 2019") +
...
# train,test and valid (train)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model4 training data till 2018") +
...
# valid (traintest)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using adl model4 training data till 2019") +
...
# train,test and valid (train)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using tree model training data till 2018") +
...
# valid (traintest)
autoplot(var.adl[,'crime'],ylab = "crime",main = "Crime prediction using tree model training data till 2019") +
